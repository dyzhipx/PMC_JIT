...
router.post("/bom/:skuId/component", async (req, res, next) => {
    try {
...
router.put("/bom/component/:id", async (req, res) => {
    const comp = await masterService.updateBomComponent(req.params.id, req.body);
    res.json(comp);
});
router.delete("/bom/component/:id", async (req, res) => {
...
router.put("/supplier/:id", async (req, res, next) => {
    try {
...
// ── Line-SKU Mapping ──
router.get("/line-sku", async (_req, res) => {
    const data = await masterService.getAllLineSkuMappings();
    res.json(data);
});
router.post("/line-sku", async (req, res, next) => {
    try {
...
router.delete("/line-sku/:skuId/:line", async (req, res) => {
    await masterService.deleteLineSkuMapping(req.params.skuId, req.params.line);
    res.json({ success: true });
});
// ── Pallet Qty ──
router.get("/pallet-qty", async (_req, res, next) => {
    try {
...
router.put("/pallet-qty/:material", async (req, res, next) => {
    try {
...
// ── UOM ──
router.get("/uom", async (_req, res, next) => {
    try {
...
// ── Block Layout ──
router.get("/block-layout", async (_req, res, next) => {
    try {
...
router.put("/block-layout", async (req, res, next) => {
    try {
...
// ── Material Receh ──
router.get("/material-receh", async (_req, res, next) => {
    try {
...
router.post("/material-receh", async (req, res, next) => {
    try {
...
router.delete("/material-receh/:materialName", async (req, res, next) => {
    try {
...
// ── Kamus Opname ──
router.get("/kamus-opname", async (_req, res, next) => {
    try {
...
router.post("/kamus-opname", async (req, res, next) => {
    try {
...
router.put("/kamus-opname/:id", async (req, res, next) => {
    try {
...
router.delete("/kamus-opname/:id", async (req, res, next) => {
    try {
...
router.post("/kamus-opname/delete-multiple", async (req, res, next) => {
    try {
